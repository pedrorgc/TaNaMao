                            ...
                            <div class="mb-3">
                                ...
                                <select name="categoria_id" class="form-control" required>
                                    ...
                                    @foreach ($categorias as $categoria)
                                        <option value="{{ $categoria->id }}"
                                            {{ $categoriaSugerida && $categoria->id == $categoriaSugerida->id ? 'selected' : '' }}>
                                            {{ $categoria->nome }}
                                            @if ($categoriaSugerida && $categoria->id == $categoriaSugerida->id)
                                ...
                                @if ($categoriaSugerida)
                                    <div class="form-text text-success">
                                        <i class="fas fa-check-circle"></i> Sugerimos:
                                        <strong>{{ $categoriaSugerida->nome }}</strong>
                                    </div>
                                @endif
                            </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="cpf_cnpj_servico"
                                            ...
                                            value="{{ $dadosPrestador['cpf_cnpj'] }}" placeholder="CPF ou CNPJ">
                                        @if ($dadosPrestador['tem_documento'])
                                    ...
                                    <div class="form-text">Deixe em branco para usar:
                                        <strong>{{ $dadosPrestador['cpf_cnpj'] ?: 'Não cadastrado' }}</strong></div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="telefone_servico"
                                            ...
                                            value="{{ $dadosPrestador['telefone'] }}" placeholder="(11) 99999-9999">
                                        @if ($dadosPrestador['tem_telefone'])
                                            <span class="input-group-text bg-success text-white">
                                                <i class="fas fa-check"></i> Do cadastro
                                            </span>
                                    ...
                                    <div class="form-text">Deixe em branco para usar:
                                        <strong>{{ $dadosPrestador['telefone'] ?: 'Não cadastrado' }}</strong></div>
                                </div>
                            </div>
                            ...
                            @if ($dadosPrestador['tem_endereco_completo'])
                                <div class="alert alert-success">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="usar_endereco_cadastro"
                                            id="usar_endereco_cadastro" value="1" checked>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="cep_servico" class="form-control cep"
                                        value="{{ $dadosPrestador['cep'] }}" placeholder="00000-000"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="cidade_servico" class="form-control"
                                        value="{{ $dadosPrestador['cidade'] }}" placeholder="Cidade"
                                        {{ $dadosPrestador['tem_endereco_completo'] ? 'disabled' : '' }}>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="estado_servico" class="form-control"
                                        ...
                                        <option value="AC" {{ $dadosPrestador['estado'] == 'AC' ? 'selected' : '' }}>
                                            Acre</option>
                                        <option value="AL" {{ $dadosPrestador['estado'] == 'AL' ? 'selected' : '' }}>
                                            Alagoas</option>
                                        <option value="AP" {{ $dadosPrestador['estado'] == 'AP' ? 'selected' : '' }}>
                                            Amapá</option>
                                        <option value="MG" {{ $dadosPrestador['estado'] == 'MG' ? 'selected' : '' }}>
                                            Minas Gerais</option>
                                        <option value="AM" {{ $dadosPrestador['estado'] == 'AM' ? 'selected' : '' }}>
                                            Amazonas</option>
                                        <option value="SP" {{ $dadosPrestador['estado'] == 'SP' ? 'selected' : '' }}>
                                            São Paulo</option>
                                        <option value="RJ" {{ $dadosPrestador['estado'] == 'RJ' ? 'selected' : '' }}>
                                            Rio de Janeiro</option>
                                        <option value="BA" {{ $dadosPrestador['estado'] == 'BA' ? 'selected' : '' }}>
                                            Bahia</option>
                                        <option value="ES" {{ $dadosPrestador['estado'] == 'ES' ? 'selected' : '' }}>
                                            Espiríto Santo</option>
                                        <option value="RS" {{ $dadosPrestador['estado'] == 'RS' ? 'selected' : '' }}>
                                            Rio Grande do Sul</option>
                                        <option value="TO" {{ $dadosPrestador['estado'] == 'TO' ? 'selected' : '' }}>
                                            Tocantins</option>
                                        <option value="PE" {{ $dadosPrestador['estado'] == 'PE' ? 'selected' : '' }}>
                                            Pernambuco</option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3" id="campo_valor_hora" style="display: none;">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="valor_hora" class="form-control" step="0.01"
                        ...
                        <div class="col-md-4 mb-3" id="campo_valor_fixo" style="display: none;">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">R$</span>
                                <input type="number" name="valor_fixo" class="form-control" step="0.01"
                                    min="0" placeholder="0,00">
                            </div>
                        </div>
                    </div>
